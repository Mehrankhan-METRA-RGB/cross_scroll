...
/// widget in a [CustomCrossScrollBar] widget.
///
...
///
/// {@tool dartpad}
/// This sample shows a [CustomCrossScrollBar] that executes a fade animation as scrolling occurs.
...
class CustomCrossScrollBar extends StatelessWidget {
...
class _CrossScroll extends RawScrollbar {
  const _CrossScroll({
    Key? key,
...
class _MaterialScrollbarState extends RawScrollbarState<_CrossScroll> {
  ...
  MaterialStateProperty<Color> get _thumbColor {
    ...
    switch (brightness) {
      case Brightness.light:
        dragColor = widget.hoverColor ?? onSurface.withOpacity(0.9);
        hoverColor = widget.hoverColor ?? onSurface.withOpacity(0.9);
        idleColor = _useAndroidScrollbar
            ? widget.idleColor ??
                Theme.of(context).highlightColor.withOpacity(0.9)
            : widget.idleColor ?? onSurface.withOpacity(0.4);
        break;
      case Brightness.dark:
        dragColor = widget.idleColor ?? onSurface.withOpacity(0.9);
        hoverColor = widget.idleColor ?? onSurface.withOpacity(0.9);
        idleColor = _useAndroidScrollbar
            ? widget.idleColor ??
                Theme.of(context).highlightColor.withOpacity(0.9)
            : widget.idleColor ?? onSurface.withOpacity(0.4);
...
class CrossScrollBar {
  const CrossScrollBar(
      ...
      this.thickness = 8,
      this.radius = const Radius.elliptical(8, 8),
  ...
  ///Currently Only supported for Vertical scrolls
